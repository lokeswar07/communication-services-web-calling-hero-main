...
export const HomeScreen = (props: HomeScreenProps): JSX.Element => {
  ...
  const headerTitle = props.joiningExistingCall ? 'Join Room' : 'Start or join a Room!';
  ...
  const [chosenRoomsRoleOption, _] = useState<IChoiceGroupOption | undefined>(roomRoleOptions[1]);
